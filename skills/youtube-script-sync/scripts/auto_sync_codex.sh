...
CODEX_BIN="$HOME/.nvm/versions/node/v24.14.0/bin/codex"
GETNOTE_BIN="$HOME/.nvm/versions/node/v24.14.0/bin/getnote"
GETNOTE_ENV="$HOME/.config/getnote/.env"
SKILL_DIR="$HOME/.agents/skills/youtube-script-sync"
TOPIC_ID="YkWaVRqY"
TOPIC_NAME="Youtube视频逐字稿"
LOG_DIR="$HOME/Library/Logs/yt-script-sync"
