...
> **English version**: 见 [`../SKILL.md`](../SKILL.md)（EN 版与本文档内容等价，按用户语言选用）。
...
|---|---|
| 输入限制 / 文件上限 | [系统约束](#系统约束) |
| `@` 引用语法 | [核心语法：@ 引用系统](#核心语法-引用系统) |
| 提示词结构公式 | [提示词结构模版](#提示词结构模版) |
| 运镜术语（推 / 拉 / 环绕 / 希区柯克等） | [运镜语言参考](#运镜语言参考) |
| 12 类场景模式 | [各场景提示词模式](#各场景提示词模式) |
| 即用模版 | [提示词模版库](#提示词模版库) |
| 常见错误 | [常见错误与避坑指南](#常见错误与避坑指南) |
| 标准撰写流程 | [交互指引](#交互指引) |
