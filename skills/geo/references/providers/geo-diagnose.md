...
1. Read `references/providers/geo-diagnose/diagnosis-method.md` and prepare the diagnosis brief contract.
2. Run the deterministic `.venv/bin/python scripts/run_diagnose.py --input <brief.json> --output <runs-root>` wrapper from the GEOHub Skill directory.
