...
1. Read `references/providers/geo-measure/measurement-method.md` and prepare a strict measurement brief.
2. Run `.venv/bin/python scripts/run_measure.py --input <brief.json> --output <runs-root>` from the GEOHub Skill directory.
