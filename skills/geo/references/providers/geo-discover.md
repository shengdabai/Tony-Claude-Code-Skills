...
1. Read 'references/providers/geo-discover/discovery-method.md' and prepare a protocol '1.0.0' GEO brief.
2. Run the deterministic `.venv/bin/python scripts/run_discover.py --input <brief.json> --output <runs-root>` wrapper from the GEOHub Skill directory.
