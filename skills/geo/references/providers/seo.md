...
1. Read `references/providers/seo/seo-method.md` and normalize the request into `references/providers/seo/input-example.json` shape.
2. Run `.venv/bin/python scripts/run_seo.py --input <brief.json> --output <runs-root>` from the GEOHub Skill directory.
